## Credit to Stephane van Gulick - http://powershelldistrict.com/create-random-files-using-powershell/
## 12/03/2018 Jacob Benson Note:  The ability to specify the file types you want is not working with this script (or I can't figure it out)
...
Function Create-RandomFiles{
    ...
    .EXAMPLE
       ...
       Will generate randomly 13 files for a total of 50mb in the path c:\users\svangulick\
     
    .EXAMPLE
       .\Create-Files.ps1 -totalsize 5GB -NumberOfFiles 3 -Path C:\Users\Svangulick\
     
       Will generate randomly 3 files for a total of 5Gigabytes in the path c:\users\svangulick\
